...
// Changed Left bracket, and right bracket, SCOLON to semicolon, not sure if it is the same
...
enum tap_dance_codes {
    ...
    /*
     * Single tap: CMD+SHIFT+5 (screen grab on Mac)
     * Hold: Next track
     */
    DANCE_65,
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT(KC_Q, KC_W, KC_E, KC_R, KC_T, /*|----|*/ KC_Y, KC_U, KC_I, KC_O, KC_P,
                 ...
                 // -------
                 KC_Z, KC_X, KC_C, KC_V, KC_B, /*|----|*/ KC_N, KC_M, TD(DANCE_3), TD(DANCE_1), TD(DANCE_2),
                 // -------
                 MT(MOD_MEH, KC_SPACE), OSM(MOD_LSFT), /*|----|*/ OSM(MOD_RCTL), TO(1)),

    /*
     * LSFT(KC_3) - Types a pound sign
     * LALT(KC_RBRC) - Remove?
     * LALT(LSFT(KC_RBRC)) - Remove?
     * LSFT(KC_LBRC) - Types a left curly brace
     * LSFT(KC_RBRC) - Types a right curly brace
     * LALT(KC_LBRC) - Remove?
     * LALT(LSFT(KC_LBRC)) - Remove?
     */
    [1] = LAYOUT(KC_ESC, KC_AT, LSFT(KC_3), TD(DANCE_31), KC_PERC, /*|----|*/ KC_CIRC, KC_AMPR, KC_ASTR, KC_COLN, KC_BSPC,
                 // -------
    ...
    /*
     * Changes
     * - Prev track, don't use that often/ever
     *   - Replace with mute/unmute (volume) (KC_MUTE)
     * - Next track, don't use that often/ever
     *   - Replace with CMD+SHIFT+5 (screen grab on Mac)
     */
    [2] = LAYOUT(KC_ESCAPE, KC_MEDIA_PLAY_PAUSE, TD(DANCE_64), TD(DANCE_65), LSFT(KC_MINS), /*|----|*/ KC_MINS, KC_7, KC_8, KC_9, KC_TRANSPARENT,
                 // -------
     ...
     */
    [3] = LAYOUT(TD(DANCE_54), KC_MS_WH_LEFT, KC_MS_UP, KC_MS_WH_RIGHT, TD(DANCE_55), /*|----|*/ LGUI(KC_LBRC), LCTL(LSFT(KC_TAB)), RCTL(KC_TAB), LGUI(KC_RBRC), KC_TRANSPARENT,
                 // -------
                 ...
                 // -------
                 TD(DANCE_58), KC_MS_BTN2, KC_MS_WH_UP, KC_MS_WH_DOWN, KC_TRANSPARENT, /*|----|*/ KC_MS_BTN1, KC_MS_ACCEL0, KC_MS_ACCEL1, KC_MS_ACCEL2, TO(4),
                 // -------
     ...
     */
    [4] = LAYOUT(QK_RBT, QK_BOOT, XXXXXXX, QK_MAKE, XXXXXXX, /*|----|*/ XXXXXXX, XXXXXXX, XXXXXXX, CM_TOGG, KC_SLEP,
                 // -------
                 XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, /*|----|*/ XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
                 // -------
                 XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, /*|----|*/ XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
                 // -------
                 TO(0), XXXXXXX, /*|----|*/ XXXXXXX, TO(1))};
...
uint8_t dance_64_dance_step(tap_dance_state_t *state);
...
void dance_64_finished(tap_dance_state_t *state, void *user_data) {
    dance_state.step = dance_64_dance_step(state);
    switch (dance_state.step) {
        case SINGLE_TAP:
            tap_code16(KC_MUTE);
            break;
...
uint8_t dance_65_dance_step(tap_dance_state_t *state);
...
void dance_65_finished(tap_dance_state_t *state, void *user_data) {
    dance_state.step = dance_65_dance_step(state);
    switch (dance_state.step) {
        case SINGLE_TAP:
            tap_code16(LGUI(LSFT(KC_5)));
            break;
